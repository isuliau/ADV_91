...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		{
		console.log("car1");
		document.getElementById('game_status').innerHTML = "¡Gano el auto 1!";
		}
		if(car2_x > 700)
		{
		console.log("car2");
		document.getElementById('game_status').innerHTML = "¡Gano el auto 2!";
		}
	}
function car1_up()
{
...
function car1_left()
{
	...
	{
		car1_x = car1_x - 10;
		console.log("Cuando se presione la flecha de izquierda, x = " + car1_x + "| y = " + car1_y)
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1_x = car1_x + 10;
		console.log("Cuando se presione la flecha de derecha, x = " + car1_x + "| y = " + car1_y)
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_up()
{
	...
	{
		car2_y = car2_y - 10;
		console.log("Cuando se presione la flecha de arriba, x = " + car2_x + "| y = " + car2_y)
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_down()
{
	...
	{
		car2_y = car2_y + 10;
		console.log("Cuando se presione la flecha de abajo, x = " + car2_x + "| y = " + car2_y)
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_left()
{
	...
	{
		car2_x = car2_x - 10;
		console.log("Cuando se presione la flecha de izquierda, x = " + car2_x + "| y = " + car2_y)
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_right()
{
	...
	{
		car2_x = car2_x + 10;
		console.log("Cuando se presione la flecha de derecha, x = " + car2_x + "| y = " + car2_y)
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
